...
{
    "location": "#Distributions.ncategories-Tuple{HurdleDMR.DCR}",
    "page": "Home",
...
{
    "location": "#HurdleDMR.dmr-Union{Tuple{AbstractArray{T,2},AbstractArray{V,2}}, Tuple{T}, Tuple{V}} where V where T<:AbstractFloat",
    "page": "Home",
    "title": "HurdleDMR.dmr",
    "category": "method",
...
{
    "location": "#HurdleDMR.hasintercept-Tuple{HurdleDMR.DCR}",
    "page": "Home",
...
{
    "location": "#HurdleDMR.ncoefs-Tuple{HurdleDMR.DMR}",
    "page": "Home",
...
{
    "location": "#HurdleDMR.ncovars-Tuple{HurdleDMR.DMR}",
    "page": "Home",
...
{
    "location": "#StatsBase.coef-Tuple{HurdleDMR.DMRCoefs}",
    "page": "Home",
...
{
    "location": "#StatsBase.coef-Tuple{HurdleDMR.DMRPaths}",
    "page": "Home",
    "title": "StatsBase.coef",
    "category": "method",
...
{
    "location": "#StatsBase.fit-Union{Tuple{D}, Tuple{T}, Tuple{Type{D},AbstractArray{T,2},AbstractArray{T,2} where T}} where D<:HurdleDMR.DMR where T<:AbstractFloat",
    "page": "Home",
    "title": "StatsBase.fit",
    "category": "method",
...
{
    "location": "#StatsBase.fit-Union{Tuple{T}, Tuple{Type{HurdleDMR.DMRPaths},AbstractArray{T,2},AbstractArray{T,2} where T}} where T<:AbstractFloat",
    "page": "Home",
    "title": "StatsBase.fit",
    "category": "method",
...
{
    "location": "#StatsBase.fit-Union{Tuple{T}, Tuple{Type{T},HurdleDMR.Model,DataFrames.AbstractDataFrame,AbstractArray{T,2} where T}} where T<:HurdleDMR.DMR",
    "page": "Home",
    "title": "StatsBase.fit",
    "category": "method",
...
{
    "location": "#StatsBase.nobs-Tuple{HurdleDMR.DCR}",
    "page": "Home",
...
{
    "location": "#StatsBase.predict-Union{Tuple{HurdleDMR.DMRPaths,AbstractArray{T,2}}, Tuple{T}} where T<:AbstractFloat",
    "page": "Home",
...
{
    "location": "#HurdleDMR.hdmr-Union{Tuple{AbstractArray{T,2},AbstractArray{V,2}}, Tuple{T}, Tuple{V}} where V where T<:AbstractFloat",
    "page": "Home",
    "title": "HurdleDMR.hdmr",
    "category": "method",
...
{
    "location": "#HurdleDMR.ncoefspos-Tuple{HurdleDMR.HDMR}",
    "page": "Home",
...
{
    "location": "#HurdleDMR.ncoefszero-Tuple{HurdleDMR.HDMR}",
    "page": "Home",
...
{
    "location": "#HurdleDMR.ncovarspos-Tuple{HurdleDMR.HDMR}",
    "page": "Home",
...
{
    "location": "#HurdleDMR.ncovarszero-Tuple{HurdleDMR.HDMR}",
    "page": "Home",
...
{
    "location": "#HurdleDMR.posindic-Tuple{AbstractArray}",
    "page": "Home",
...
{
    "location": "#HurdleDMR.posindic-Tuple{SparseMatrixCSC}",
    "page": "Home",
    "title": "HurdleDMR.posindic",
    "category": "method",
...
{
    "location": "#StatsBase.coef-Tuple{HurdleDMR.HDMRCoefs}",
    "page": "Home",
    "title": "StatsBase.coef",
    "category": "method",
...
{
    "location": "#StatsBase.coef-Tuple{HurdleDMR.HDMRPaths}",
    "page": "Home",
    "title": "StatsBase.coef",
    "category": "method",
...
{
    "location": "#StatsBase.fit-Union{Tuple{H}, Tuple{T}, Tuple{Type{H},AbstractArray{T,2},AbstractArray{T,2} where T}} where H<:HurdleDMR.HDMR where T<:AbstractFloat",
    "page": "Home",
    "title": "StatsBase.fit",
    "category": "method",
...
{
    "location": "#StatsBase.fit-Union{Tuple{T}, Tuple{Type{HurdleDMR.HDMRPaths},AbstractArray{T,2},AbstractArray{T,2} where T}} where T<:AbstractFloat",
    "page": "Home",
    "title": "StatsBase.fit",
    "category": "method",
...
{
    "location": "#StatsBase.fit-Union{Tuple{T}, Tuple{Type{T},HurdleDMR.Model,DataFrames.AbstractDataFrame,AbstractArray{T,2} where T,Vararg{Any,N} where N}} where T<:HurdleDMR.HDMR",
    "page": "Home",
    "title": "StatsBase.fit",
    "category": "method",
...
{
    "location": "#StatsBase.predict-Union{Tuple{HurdleDMR.HDMRPaths,AbstractArray{T,2}}, Tuple{T}} where T<:AbstractFloat",
    "page": "Home",
    "title": "StatsBase.predict",
    "category": "method",
...
{
    "location": "#HurdleDMR.srproj-Union{Tuple{AbstractArray{T,2},Any,Union{Int64, Void}}, Tuple{AbstractArray{T,2},Any}, Tuple{T}} where T",
    "page": "Home",
    "title": "HurdleDMR.srproj",
    "category": "method",
    "text": "srproj calculates the MNIR Sufficient Reduction projection from text counts on to the attribute dimensions of interest (covars in mnlm). In particular, for counts C, with row sums m, and mnlm coefficients φ_j corresponding to attribute j, z_j = C\'φ_j/m is the SR projection in the direction of j. The MNIR paper explains how V=[v_1 ... v_K], your original covariates/attributes, are independent of text counts C given SR projections Z=[z_1 ... z_K].\n\n\n\n"
...
{
    "location": "#HurdleDMR.srproj-Union{Tuple{AbstractArray{T,2},SparseMatrixCSC,Int64}, Tuple{T}} where T",
    "page": "Home",
    "title": "HurdleDMR.srproj",
    "category": "method",
...
{
    "location": "#HurdleDMR.srproj-Union{Tuple{C,C,Any,D,D}, Tuple{C}, Tuple{D}, Tuple{T}} where D<:Union{Int64, Void} where C<:AbstractArray{T,2} where T",
    "page": "Home",
    "title": "HurdleDMR.srproj",
    "category": "method",
...
{
    "location": "#HurdleDMR.srproj-Union{Tuple{D}, Tuple{HurdleDMR.HDMR,Any,D,D}, Tuple{HurdleDMR.HDMR,Any,D}, Tuple{HurdleDMR.HDMR,Any}} where D<:Union{Int64, Void}",
    "page": "Home",
    "title": "HurdleDMR.srproj",
    "category": "method",
    "text": "srproj for hurdle dmr takes two coefficent matrices coefspos, coefszero, and a two specific directions and returns an n-by-3 matrix Z = [zpos zzero m]. dirpos = 0 omits positive counts projections and dirzero = 0 omits zero counts projections.\n\n\n\n"
...
{
    "location": "#HurdleDMR.srprojX-Union{Tuple{AbstractArray{T,2},Any,Any,Any}, Tuple{T}} where T",
    "page": "Home",
...
{
    "location": "#HurdleDMR.srprojX-Union{Tuple{M,M,Any,Any,Int64}, Tuple{M}, Tuple{T}} where M<:AbstractArray{T,2} where T",
    "page": "Home",
    "title": "HurdleDMR.srprojX",
    "category": "method",
...
{
    "location": "#HurdleDMR.coefbwd-Tuple{HurdleDMR.CIR}",
    "page": "Home",
...
{
    "location": "#HurdleDMR.coeffwd-Tuple{HurdleDMR.CIR}",
    "page": "Home",
...
{
    "location": "#StatsBase.fit-Union{Tuple{BM}, Tuple{C}, Tuple{FM}, Tuple{Type{C},HurdleDMR.Model,DataFrames.AbstractDataFrame,AbstractArray{T,2} where T,Symbol,Vararg{Any,N} where N}} where C<:HurdleDMR.CIR{BM,FM} where FM<:StatsBase.RegressionModel where BM<:HurdleDMR.DMR",
    "page": "Home",
    "title": "StatsBase.fit",
    "category": "method",
...
{
    "location": "#StatsBase.fit-Union{Tuple{BM}, Tuple{C}, Tuple{FM}, Tuple{Type{C},HurdleDMR.Model,DataFrames.AbstractDataFrame,AbstractArray{T,2} where T,Symbol,Vararg{Any,N} where N}} where C<:HurdleDMR.CIR{BM,FM} where FM<:StatsBase.RegressionModel where BM<:HurdleDMR.HDMR",
    "page": "Home",
    "title": "StatsBase.fit",
    "category": "method",
...
{
    "location": "#StatsBase.fit-Union{Tuple{BM}, Tuple{C}, Tuple{FM}, Tuple{T}, Tuple{Type{C},AbstractArray{T,2},AbstractArray{V,2},Int64,Vararg{Any,N} where N}, Tuple{V}} where C<:HurdleDMR.CIR{BM,FM} where FM<:StatsBase.RegressionModel where BM<:HurdleDMR.DCR where V where T<:AbstractFloat",
    "page": "Home",
    "title": "StatsBase.fit",
    "category": "method",
...
{
    "location": "#StatsBase.predict-Union{Tuple{HurdleDMR.CIR,AbstractArray{T,2},AbstractArray{V,2}}, Tuple{T}, Tuple{V}} where V where T<:AbstractFloat",
    "page": "Home",
    "title": "StatsBase.predict",
    "category": "method",
...
{
    "location": "#StatsBase.predict-Union{Tuple{M}, Tuple{MM,DataFrames.AbstractDataFrame,AbstractArray{T,2} where T}, Tuple{MM}, Tuple{T}} where MM<:Union{HurdleDMR.CIR, StatsModels.DataFrameRegressionModel{M,T}} where M<:HurdleDMR.CIR where T",
    "page": "Home",
    "title": "StatsBase.predict",
    "category": "method",
...
{
    "location": "#StatsBase.coef-Tuple{HurdleDMR.Hurdle}",
    "page": "Home",
    "title": "StatsBase.coef",
    "category": "method",
...
{
    "location": "#StatsBase.fit-Union{Tuple{M}, Tuple{Type{HurdleDMR.Hurdle},Type{M},StatsModels.Formula,DataFrames.AbstractDataFrame,Distributions.Distribution{Distributions.Univariate,S} where S<:Distributions.ValueSupport,Distributions.Distribution{Distributions.Univariate,S} where S<:Distributions.ValueSupport,GLM.Link,GLM.Link}, Tuple{Type{HurdleDMR.Hurdle},Type{M},StatsModels.Formula,DataFrames.AbstractDataFrame,Distributions.Distribution{Distributions.Univariate,S} where S<:Distributions.ValueSupport,Distributions.Distribution{Distributions.Univariate,S} where S<:Distributions.ValueSupport,GLM.Link}, Tuple{Type{HurdleDMR.Hurdle},Type{M},StatsModels.Formula,DataFrames.AbstractDataFrame,Distributions.Distribution{Distributions.Univariate,S} where S<:Distributions.ValueSupport,Distributions.Distribution{Distributions.Univariate,S} where S<:Distributions.ValueSupport}, Tuple{Type{HurdleDMR.Hurdle},Type{M},StatsModels.Formula,DataFrames.AbstractDataFrame,Distributions.Distribution{Distributions.Univariate,S} where S<:Distributions.ValueSupport}, Tuple{Type{HurdleDMR.Hurdle},Type{M},StatsModels.Formula,DataFrames.AbstractDataFrame}} where M<:StatsBase.RegressionModel",
    "page": "Home",
    "title": "StatsBase.fit",
    "category": "method",
...
{
    "location": "#StatsBase.fit-Union{Tuple{M}, Tuple{T}, Tuple{Type{HurdleDMR.Hurdle},Type{M},AbstractArray{T,2},V,Distributions.Distribution{Distributions.Univariate,S} where S<:Distributions.ValueSupport,Distributions.Distribution{Distributions.Univariate,S} where S<:Distributions.ValueSupport,GLM.Link,GLM.Link}, Tuple{Type{HurdleDMR.Hurdle},Type{M},AbstractArray{T,2},V,Distributions.Distribution{Distributions.Univariate,S} where S<:Distributions.ValueSupport,Distributions.Distribution{Distributions.Univariate,S} where S<:Distributions.ValueSupport,GLM.Link}, Tuple{Type{HurdleDMR.Hurdle},Type{M},AbstractArray{T,2},V,Distributions.Distribution{Distributions.Univariate,S} where S<:Distributions.ValueSupport,Distributions.Distribution{Distributions.Univariate,S} where S<:Distributions.ValueSupport}, Tuple{Type{HurdleDMR.Hurdle},Type{M},AbstractArray{T,2},V,Distributions.Distribution{Distributions.Univariate,S} where S<:Distributions.ValueSupport}, Tuple{Type{HurdleDMR.Hurdle},Type{M},AbstractArray{T,2},V}, Tuple{V}} where V<:(AbstractArray{T,1} where T<:AbstractFloat) where T<:AbstractFloat where M<:StatsBase.RegressionModel",
    "page": "Home",
    "title": "StatsBase.fit",
    "category": "method",
    "text": "fit(Hurdle,M,X,y; Xpos=Xpos, <keyword arguments>)\n\nFit a Hurdle (Mullahy, 1986) of count vector y on X with potentially another covariates matrix Xpos used to model positive counts.\n\nExample with GLM:\n\n  m = fit(Hurdle,GeneralizedLinearModel,X,y; Xpos=Xpos)\n  yhat = predict(m, X; Xpos=Xpos)\n\nExample with Lasso regularization:\n\n  m = fit(Hurdle,GammaLassoPath,X,y; Xpos=Xpos)\n  yhat = predict(m, X; Xpos=Xpos, select=:AICc)\n\nArguments\n\nM::RegressionModel\ncounts n-by-d matrix of counts (usually sparse)\ndzero::UnivariateDistribution = Binomial() distribution for zeros model\ndpos::UnivariateDistribution = PositivePoisson() distribution for positives model\nlzero::Link=canonicallink(dzero) link function for zeros model\nlpos::Link=canonicallink(dpos) link function for positives model\n\nKeywords\n\nXpos::Union{AbstractMatrix{T},Void} = nothing covariates matrix for positives model or nothing to use X for both parts\ndofit::Bool = true fit the model or just construct its shell\nwts::V = ones(y) observation weights\noffsetzero::AbstractVector = similar(y, 0) offsets for zeros model\noffsetpos::AbstractVector = similar(y, 0) offsets for positives model\noffset::AbstractVector = similar(y, 0) offsets for both model parts\nverbose::Bool=true\nshowwarnings::Bool=false\nfitargs... additional keyword arguments passed along to fit(M,...)\n\n\n\n"
},

{
    "location": "#StatsBase.predict-Union{Tuple{HurdleDMR.Hurdle,AbstractArray{T,2}}, Tuple{T}} where T<:AbstractFloat",
    "page": "Home",
    "title": "StatsBase.predict",
    "category": "method",
